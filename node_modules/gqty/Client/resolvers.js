...
function createResolvers(innerState, catchSelectionsTimeMS, subscriptions) {
  ...
  async function buildAndFetchSelections(selections, type, cache = innerState.clientCache, options = {}, lastTryParam) {
    ...
    if (!options.scheduler)
      return resolve();
    let promise$1 = resolveQueryPromisesMap[cacheKey];
    if (promise$1)
      return promise$1;
    promise$1 = promise.LazyPromise(() => {
      return resolve();
    });
    resolveQueryPromisesMap[cacheKey] = promise$1;
    try {
    ...
    async function resolve() {
      ...
      try {
        ...
        if (eventHandler.hasFetchSubscribers) {
          loggingPromise = promise.createDeferredPromise();
