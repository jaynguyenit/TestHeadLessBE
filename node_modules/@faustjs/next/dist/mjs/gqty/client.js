...
export function getClient(clientConfig, createReactClientOpts) {
    ...
    const haveServerContext = isObject((_a = clientConfig.context) === null || _a === void 0 ? void 0 : _a.apiClient);
    let nextClient;
    function useClient() {
        var _a;
        let client = (_a = useContext(FaustContext)) === null || _a === void 0 ? void 0 : _a.client;
