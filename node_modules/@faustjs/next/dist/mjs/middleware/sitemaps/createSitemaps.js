...
import { FAUST_PAGES_PATHNAME, } from './handleSitemapRequests.js';
import { createSitemap, createSitemapIndex, isArray, trimSlashes, isUndefined, } from './sitemapUtils.js';
const parserConfig = {
 ...
 */
export async function createRootSitemapIndex(req, normalizedConfig, isMiddleware = true) {
    var _a;
 ...
 * @returns {Response|undefined}
 */
export function createPagesSitemap(req, normalizedConfig, isMiddleware = true) {
    if (!req.url) {
        throw new Error('Request object must have URL');
    }
    let frontendUrl = '';
 ...
 */
export async function handleSitemapPath(req, normalizedConfig, isMiddleware = true) {
    var _a;
 ...
 * @returns {Promise<Response|Undefined>}
 */
export async function handleRobotsTxt(req, normalizedConfig) {
    const { origin } = new URL(req.url);
