...
async function getProps(context, { client, Page, props, }) {
    ...
    return {
        props: Object.assign({ [exports.CLIENT_CACHE_PROP]: cacheSnapshot !== null && cacheSnapshot !== void 0 ? cacheSnapshot : null, [exports.AUTH_CLIENT_CACHE_PROP]: authSnapshot !== null && authSnapshot !== void 0 ? authSnapshot : null }, props),
    };
}
...
async function getNextStaticProps(context, cfg) {
    ...
    if ((0, isObject_js_1.default)(pageProps.props)) {
