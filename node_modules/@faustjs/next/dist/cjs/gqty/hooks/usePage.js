...
function create(useQuery) {
    return (args) => {
        ...
        if ((0, index_js_1.hasPageId)(query)) {
            params = Object.assign({ id: query.pageId, idType: client_1.PageIdType.ID }, params);
        }
        if ((0, index_js_1.hasPageUri)(query)) {
            params = Object.assign({ id: query.pageUri.join('/'), idType: client_1.PageIdType.URI }, params);
        }
