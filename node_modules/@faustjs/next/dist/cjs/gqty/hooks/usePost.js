...
function create(useQuery) {
    return (args) => {
        ...
        if ((0, index_js_1.hasPostId)(query)) {
            params = Object.assign({ id: query.postId, idType: client_1.PostIdType.ID }, params);
        }
        else if ((0, index_js_1.hasPostSlug)(query)) {
            params = Object.assign({ id: query.postSlug, idType: client_1.PostIdType.SLUG }, params);
        }
        else if ((0, index_js_1.hasPostUri)(query)) {
            params = Object.assign({ id: query.postUri.join('/'), idType: client_1.PostIdType.URI }, params);
        }
