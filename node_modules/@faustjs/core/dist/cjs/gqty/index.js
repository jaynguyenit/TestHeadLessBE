...
function getClient(clientConfig) {
    ...
    const apiClient = Object.assign(Object.assign({}, (0, gqty_1.createClient)(Object.assign({ schema,
        scalarsEnumsHash, queryFetcher: configQueryFetcher !== null && configQueryFetcher !== void 0 ? configQueryFetcher : createQueryFetcher(applyRequestContext) }, (0, omit_js_1.default)(clientConfig, 'context', 'applyRequestContext', 'authQueryFetcher', 'schema', 'scalarsEnumsHash')))), { auth: Object.assign({}, (0, gqty_1.createClient)(Object.assign({ schema,
            scalarsEnumsHash, queryFetcher: configAuthQueryFetcher !== null && configAuthQueryFetcher !== void 0 ? configAuthQueryFetcher : createAuthQueryFetcher(context, applyRequestContext) }, (0, omit_js_1.default)(clientConfig, 'context', 'applyRequestContext', 'authQueryFetcher', 'schema', 'scalarsEnumsHash')))) });
