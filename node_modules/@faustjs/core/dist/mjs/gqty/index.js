...
export function getClient(clientConfig) {
    ...
    const apiClient = Object.assign(Object.assign({}, createClient(Object.assign({ schema,
        scalarsEnumsHash, queryFetcher: configQueryFetcher !== null && configQueryFetcher !== void 0 ? configQueryFetcher : createQueryFetcher(applyRequestContext) }, omit(clientConfig, 'context', 'applyRequestContext', 'authQueryFetcher', 'schema', 'scalarsEnumsHash')))), { auth: Object.assign({}, createClient(Object.assign({ schema,
            scalarsEnumsHash, queryFetcher: configAuthQueryFetcher !== null && configAuthQueryFetcher !== void 0 ? configAuthQueryFetcher : createAuthQueryFetcher(context, applyRequestContext) }, omit(clientConfig, 'context', 'applyRequestContext', 'authQueryFetcher', 'schema', 'scalarsEnumsHash')))) });
